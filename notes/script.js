...
const firebaseConfig = {
	apiKey: "AIzaSyCGFYhTDDkV_CNAueOEdkF8WRkL0gL1NNk",
	authDomain: "wikinext-0007.firebaseapp.com",
	projectId: "wikinext-0007",
	storageBucket: "wikinext-0007.appspot.com",
	messagingSenderId: "1073252568009",
	appId: "1:1073252568009:web:53d9bbe34d1dffc5303618",
	databaseURL: "https://wikinext-0007-default-rtdb.asia-southeast1.firebasedatabase.app/",
};
...
const md = `# The Film and Television Charity
...
const saver = async () => {
	await setDoc(doc(db, "pages", "The Film and Television Charity"), {
		content: md,
		tags: [
			"Social Welfare Charities [UK]",
			"Film Organisations [UK]",
			"Mental Health Organisation [UK]",
		],
	});
	console.log("done");
};
